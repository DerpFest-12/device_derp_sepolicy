...
SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS += \
    ...
    device/derp/sepolicy/common/system

ifneq ($(TARGET_HAL_POWER_RW_INPUT_DEVICE), true)
SYSTEM_EXT_PRIVATE_SEPOLICY_DIRS += \
    device/derp/sepolicy/common/dynamic_extra
endif
else
...
-include device/derp/sepolicy/legacy-common/sepolicy.mk

# Include atv rules on atv product
ifeq ($(PRODUCT_IS_ATV), true)
include device/derp/sepolicy/atv/sepolicy.mk
endif
